...
const RedActionCardBackground: FC<SVGProps> = ({
  ...
  >
    ...
    <path
      ...
      stroke="url(#paint2_linear_1499_77)"
      strokeWidth="73"
      strokeLinecap="round"
    />
    <circle cx="164.5" cy="111.5" r="14.5" fill="url(#paint3_radial_1499_77)" />
    <circle cx="21" cy="312" r="7" fill="url(#paint4_radial_1499_77)" />
    <defs>
      <linearGradient
        id="paint0_linear_1499_77"
        x1="62.5"
        y1="70.5"
        x2="129"
        y2="168.5"
      ...
      >
        <stop stopColor="#8BE9F3" />
        <stop offset="1" stopColor="#6EFF57" />
      </linearGradient>
      <linearGradient
        id="paint1_linear_1499_77"
        x1="113"
        y1="-5"
        x2="-55.5"
        y2="59.5"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#8BE8F3" />
        <stop offset="1" stopColor="#69FC82" />
      </linearGradient>
      <linearGradient
        id="paint2_linear_1499_77"
        x1="21.5"
        y1="168.5"
        x2="6.99997"
        y2="285.523"
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#6EFF57" />
        <stop offset="1" stopColor="#76F5AC" />
      </linearGradient>
      <radialGradient
        id="paint3_radial_1499_77"
        cx="0"
        cy="0"
        r="1"
        gradientUnits="userSpaceOnUse"
      ...
      >
        <stop stopColor="#6DFF57" />
        <stop offset="1" stopColor="#8BE8F3" />
      </radialGradient>
      <radialGradient
        id="paint4_radial_1499_77"
        cx="0"
        cy="0"
        r="1"
        gradientUnits="userSpaceOnUse"
      ...
      >
        <stop stopColor="#72F98A" />
        <stop offset="1" stopColor="#87EAE7" />
      </radialGradient>
    </defs>
  </svg>
);
